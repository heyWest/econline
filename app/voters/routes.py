...
def voters_vote(election_id, index_number):
    ...
    if request.method == 'POST':
        if voter.campus == "Main":
            ...
            president_main = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                       portfolio="President").first()
            ...
            vice_main = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                  portfolio="Vice President").first()
            ...
            financial = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                  portfolio="Financial Controller").first()
            ...
            organa_vote = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                    name=organa).first()
            if organa_vote:
            ...
            general_vote = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                     name=general).first()
            if general_vote:
            ...
            vice_city = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                  portfolio="Vice President").first()
            ...
            treasurer = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                  portfolio="Treasurer").first()
            ...
            coordinator = Candidate.query.filter_by(election_id=voter.election_id, campus=voter.campus,
                                                    portfolio="Coordinator").first()
